...
def read_calib(calib_path):
    ...
    P11=P11.reshape((4,4))    
    #计算得到的
    P_pnp=np.array((1.0340901115881806e-01,-9.9461912090367943e-01,-6.2754078710030026e-03,2.7789799721451591e-01,
                -4.4844446144971101e-01,-4.0990638822253622e-02,-8.9287027754541270e-01,-7.9925451199355102e-01,
                8.8780861755573992e-01,9.5145004397159727e-02,-4.5027023744861294e-01,-2.7534662575847335e-01,
                0, 0, 0, 1),np.float32)
    P_pnp=P_pnp.reshape((4,4))
    
    IPU2_CAM1=np.array((0.14495024424955144, -0.9892874965026629, -0.017311858954031516, 0.24357166482617432,
                ...
                0, 0, 0, 1),np.float32)
    IPU2_CAM1=IPU2_CAM1.reshape((4,4))

    #P11[0:3,3]=P_pnp[0:3,3]
    #P11[0:3,0:3]=IPU2_CAM1[0:3,0:3]
